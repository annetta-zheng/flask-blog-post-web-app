...
from starter.forms import RegistrationForm, LoginForm
...
post1 = Post(title='Post001', content='John first post', user_id=user1.id)
post2 = Post(title='Post002', content='John second post', user_id=user1.id)
post3 = Post(title='Post101', content='Sam first post', user_id=user2.id)
